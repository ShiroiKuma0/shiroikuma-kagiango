...
namespace keepass2android.search
{
  ...
  /// </summary>
  [Activity(Label = "@string/app_name", Theme = "@style/Kp2aTheme_NoActionBar", LaunchMode = Android.Content.PM.LaunchMode.SingleTop, ConfigurationChanges = ConfigChanges.Orientation | ConfigChanges.Keyboard | ConfigChanges.KeyboardHidden)]
